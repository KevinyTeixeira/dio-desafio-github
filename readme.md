...
- [ ] Trabalhando com Componentes em React; :file_folder: [[**Conteúdo**]](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/ReactsJs/1.%20Introdu%C3%A7%C3%A3o%20ao%20React.md) | :paperclip: [**[Certificado]**]()
- [ ] Desenvolvimento de aplicações para internet com ReactJS; :file_folder: [[**Conteúdo**]](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/ReactsJs/1.%20Introdu%C3%A7%C3%A3o%20ao%20React.md) | :paperclip: [**[Certificado]**]()
- [ ] Práticas avançadas em projetos com ReactJS; :file_folder: [[**Conteúdo**]](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/ReactsJs/1.%20Introdu%C3%A7%C3%A3o%20ao%20React.md) | :paperclip: [**[Certificado]**]()
