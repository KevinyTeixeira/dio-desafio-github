...
Acesse o **[documento de estudo do JavaScript ES6 Avançado](link)** para mais detalhes práticos da programação em sí.
...
- **Currying:** cria uma outra função dentro de uma função já existente, permitindo que um dos parâmetros utilizados possam usar declarações simplificadas.
  - :globe_with_meridians: **[Exemplo de Currying](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Conceitos/Currying.js)**;
- **Hoisting:** permite que uma variável ou função seja utilizada, mesmo que esta ainda não tenha sido "lida" pela execução do código. Isso impede que o código apresente um erro, entretanto o valor da variável é mostrado como "Undefined". O Hoisting **também pode ser aplicado em funções**, com o único diferencial de que para as funções.
  - :globe_with_meridians: **[Exemplo de Hoisting](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Conceitos/Hoisting.js)**;
- **Imutabilidade:** é um conceito que prevê a imutabilidade de objetos. Quando você tenta inserir um novo atributo a um objeto, ao invés de acrescentá-lo, o JavaScript cria um novo objeto, cópia do último e inclui o novo atributo.
  - :globe_with_meridians: **[Exemplo de Imutabilidade](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Conceitos/Imutabilidade.js)**;
...
1. `string`; 
   - Veja aqui os **[comandos mais utilizados de STRING](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/String.js)**;
2. `number`;
   - Veja aqui os **[comandos mais utilizados de NUMBER](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/Number.js)**;
3. `boolean`;
   - Veja aqui os **[comandos mais utilizados de BOOLEAN](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/Boolean.js)**;
4. `null`;
   - Veja aqui os **[comandos mais utilizados de NULL](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/Null.js)**;
5. `undefined`;
   - Veja aqui os **[comandos mais utilizados de UNDEFINED](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/Undefined.js)**;
6. `symbol`;
   - Veja aqui os **[comandos mais utilizados de SYMBOL](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/Symbol.js)**;
7. `object`;
   - Veja aqui os **[comandos mais utilizados de OBJECT](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/Object.js)**;
8. `function`;
   - Veja aqui os **[comandos mais utilizados de FUNCTION](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/Functions.js)**;
9. `array`;
   - Veja aqui os **[comandos mais utilizados de ARRAY](https://github.com/KevinyTeixeira/dio-desafio-github/blob/main/JavaScript%20ES6%20Essencial/Tipos%20de%20Vari%C3%A1veis%20%2B%20Comandos/array.js)**;
